...
**전 계층 재검증.** 타입·lint·lint:deps 통과, 단위 **1258**(1 skipped), a11y **192**, e2e **67**, 통합 **767**, 회귀 **70**, contrast 80쌍, `pnpm build` 통과. **변이 17종 전부 킬.** 문서 validator `--strict`는 기존 플레이스홀더 2건(9+5)으로 변화 없다.
