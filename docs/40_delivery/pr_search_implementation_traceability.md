...
**세 판이 내 수정의 부작용이었다.** 고친 것을 다시 보게 하지 않았다면 셋 다 남았을 것이고, 그중 하나는 "major를 고쳤다"는 기록이 사실과 다른 상태였다. 리뷰어가 자기 첫 재측정이 무효였다고 먼저 밝힌 것도 같은 규율이다 — 도구가 틀렸을 가능성을 먼저 의심하는 편이 결과를 믿을 수 있게 한다.
