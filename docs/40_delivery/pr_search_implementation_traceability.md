...
> 상태: review | 버전: v0.9 | 갱신일: 2026-08-23
...
**다음은 WP-023 앵커 정규화와 범위 조회 API다** (선행 WP-021·WP-013 충족). 이 제품의 사용자 대면 핵심 — "1280번부터 1342번까지" — 이 거기서 처음 응답이 된다. WP-067·WP-068은 여전히 독립이다.
