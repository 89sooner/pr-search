...
> 상태: review | 버전: v2.5 | 갱신일: 2026-08-26
...
| WP-030 | 되돌림·체리픽·스택 관계 파생 | REL-004 | in_progress | 에이전트 | - | - | **CR-041 신설.** 착수 전 감사가 열여덟을 찾았고 **열둘이 같은 뿌리**다 — 계약이 source 본문만 보고 **후보의 변화**를 보지 않는다 (DEV-230~247) |
...
| WP-030 되돌림·체리픽·스택 관계 파생 | in_progress |
