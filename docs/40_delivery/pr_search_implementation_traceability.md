...
> 상태: review | 버전: v2.8 | 갱신일: 2026-08-26
...
**다음은 WP-032 착수 전 계약 감사다** (패싯·커서 페이지네이션·전문 검색). 순서는 아홉 번 연속으로 값을 했다 — **감사 → CR → 구현**이다. 구현부터 시작하지 않는다. 감사에서 물을 것 넷:
...
**"착수 전 감사에서 계약 공백이 나왔다"가 아홉 번 연속이다** (CR-029·030·031·033·035·038·039·041·042). 이번에 나온 것은 **한 겹 아래 형태**였다 — WP-029는 "본문이 바뀐다"를 놓치고 있었고, WP-030은 **"다른 엔티티의 상태가 바뀐다"**를 놓치고 있었다. 다음 WP에서 먼저 물을 것: **이 파생의 답을 바꾸는 것이 source 말고 또 무엇인가, 그것이 바뀔 때 누가 깨우는가.**
