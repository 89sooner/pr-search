...
> 상태: review | 버전: v6.15 | 갱신일: 2026-08-31
...
| WP-069 | 작성자 소속 팀 채우기 | REL-006 | done | 에이전트 | PR #106 | DoD 13항 전부 통과 · 변이 23종 전부 킬 · 리뷰 1건 실결함(DEV-488) (6.58장) | **CR-058 계약 선행 (2026-08-31).** 착수 전 감사가 계약 공백 일곱과 릴리스 회계 공백 넷을 찾았다 (DEV-477~487). **이 행 자체가 그 감사의 첫 발견이다** — `CR-056`이 `WP-069`을 신설하면서 이 표에 담지 않아 `REL-006`이 4개짜리 슬라이스로 읽히고 있었다. 작업 패키지 문서는 요약 표와 커버리지 표(5) 둘 다에 담고 있었다 |
