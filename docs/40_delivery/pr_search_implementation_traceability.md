...
> 상태: review | 버전: v6.52 | 갱신일: 2026-09-08
...
**병합된 main `a17bb18`에서 `--release` 없이 만들었다.** 결정자가 발행 범위를 "빌드까지"로
정했고, `immutable releases`가 켜진 뒤로는 버전 이름이 한 번만 쓰이므로 발행은 검사가
끝난 뒤 사람이 정한다.

| 항목 | 값 |
| --- | --- |
| 대상 커밋 | `a17bb18f9cee25fcb655fd01ddce7dc360f3758a` (`main`) |
| 운반 아카이브 | `pr-search-0.1.0-pilot.3-offline.tar.gz` · 1,128,779,742바이트 |
| SHA-256 | `3572da6c1c0784f0ed6bf3290d52f6f8972b4a400c4d7e4d88526b2edcd14833` |
