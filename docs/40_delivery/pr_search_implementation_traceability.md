...
**현재 상태: WP-001 완료.** 워크스페이스 골격이 서 있고 `pnpm typecheck / lint / lint:deps / test / build`가 통과한다. 도메인 로직·API·화면은 아직 없다.
...
4. ~~WP-001 워크스페이스와 공유 패키지 골격~~ → 완료 (2026-08-19). 검증 결과는 6.1장
