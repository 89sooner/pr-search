...
| DEV-703 | 2026-09-17 | CR-096 영문 전환으로 web 기동 경고가 `Warning: ALLOW_INSECURE_COOKIES=true`가 됐지만 release smoke와 fake-docker fixture가 옛 `경고:`를 찾아, 위험 경고가 실제 출력됐는데도 pilot.10 번들을 발행 전에 거부했다 | NFR-007 / WP-084·WP-085 | 검증 계약 불일치 | CR-096 | resolved — smoke와 fixture가 실제 영문 경고를 대조한다. 첫 pilot.10 실행은 태그·릴리스를 만들기 전 중단됨을 확인했고 같은 main 계보에서 재시도한다 |
