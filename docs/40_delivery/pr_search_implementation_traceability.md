...
| WP-086 | 사내 권한명·operator 바로가기 보정 | 권한·UI 보정 (CR-098) | done | 에이전트 | 로컬 변경 | 권한22/22·reader/operator DOM/접근성33/33·타입·lint·빌드·Chromium 날짜/Source 회귀 통과 | 사내 재반입 NOT RUN, PR·릴리스 발행 진행 |
