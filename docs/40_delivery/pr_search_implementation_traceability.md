...
> 상태: review | 버전: v6.25 | 갱신일: 2026-09-02
...
| WP-071 | 사내 반입 운반 아카이브와 실행 절차 정본화 | **배포 (CR-062)** | todo | - | - | - | **`CR-062` 계약 선행 (2026-09-02).** 착수 전 감사가 운반 단위 부재(DEV-523)와 최초 설치 순서의 실행 불가(DEV-524)를 찾았다 (6.63장). `WP-070` 다음의 배포 마일스톤 후속이며 **`REL-006` 완료율에 넣지 않는다.** `WP-070`의 `done`은 되돌리지 않는다 — 당시 DoD는 당시 증거로 완료됐고, 이 WP는 그 위에 사람이 실제 수행할 절차를 세운다 |
