...
> 상태: review | 버전: v2.64 | 갱신일: 2026-09-24
...
- 상태: in progress — 구현·검증·독립 리뷰 완료, PR #230 병합 대기(브랜치 `feature/cr117-source-commits`). 병합은 사용자 결정이다.
...
| --- | --- | --- | --- | --- |
| WP-102 | 원본 커밋은 그 PR이 새로 가져온 커밋 — 추적 브랜치 체인 규칙 | 요구사항 공백 수정 (CR-117) | WP-101, WP-021, WP-022, WP-028, WP-017, WP-035 | in progress — PR #230 병합 대기(브랜치 `feature/cr117-source-commits`), 원장 6.108장 |
