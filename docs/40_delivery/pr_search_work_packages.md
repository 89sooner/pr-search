...
- 상태: in_progress — 브랜치 `feature/cr115-mnumber-tags`(CR-114 위에 stacked). 진행 정본은 원장 6.106장이다.
...
| --- | --- | --- | --- | --- |
| WP-100 | 확정된 M 번호의 원격 lightweight 태그 | 기능 누락 보완 (CR-115) | WP-074, WP-075, WP-098, WP-099 | in_progress — 브랜치 `feature/cr115-mnumber-tags`(CR-114 위에 stacked), 원장 6.106장; 병합은 사용자 지시 뒤, CR-114 다음 |
