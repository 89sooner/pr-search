...
- 상태: in progress — 브랜치 `feature/cr117-source-commits`.
...
| --- | --- | --- | --- | --- |
| WP-102 | 원본 커밋은 그 PR이 새로 가져온 커밋 — 추적 브랜치 체인 규칙 | 요구사항 공백 수정 (CR-117) | WP-101, WP-021, WP-022, WP-028, WP-017, WP-035 | in progress — 브랜치 `feature/cr117-source-commits`, 원장 6.108장 |
