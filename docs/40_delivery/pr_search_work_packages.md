...
> 상태: review | 버전: v2.59 | 갱신일: 2026-09-22
...
- 상태: in_progress — 워크트리 `/home/roqkf/pr-search-wt/cr113-seq-projection`(브랜치 `feature/cr113-sequence-projection`). 진행·검증은 원장 6.104장.
...
| --- | --- | --- | --- | --- |
| WP-098 | 머지 시퀀스의 Elasticsearch 투영 수렴 | 신뢰성 결함 수정 (CR-113) | WP-021, WP-022, WP-028, WP-035, WP-074 | in_progress — 원장 6.104장 |
