...
- 완료 기준(DoD):
  - [ ] QA-W002-01, QA-W002-02, QA-W002-15, QA-W002-18이 통과한다
  - [ ] **QA-W002-03은 절반만** — "절삭 표시"는 여기서, "전체 건수"는 `EVT-ING-002` 확장 뒤 (CR-020, DEV-082)
  - [ ] **QA-W002-17도 절반만** — "확장 전에 조회하지 않는다"는 여기서, "확장하면 조회한다"는 WP-031 (CR-020, DEV-088)
