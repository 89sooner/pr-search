...
8. **구현은 `WP-072`가 한다** — `build-bundle.sh`(`--release`), `deploy/single-host/RUNBOOK.md`(1장·2장·6장·7장·8장), 회귀 시험. 시험 릴리스를 실제로 만들어 토큰만 있는 환경에서 받아 검증한 뒤 지운다.
