...
시작 `origin/main`은 `c1246c5c8989b128efba16c153bc6d29b9722b21`, 브랜치는 `feature/wp074-squash-mnumber`다. **SRS·파생 UI·아키텍처 문서는 바꾸지 않았다** — CR-079가 이미 계약을 확정했고 이 판은 그것을 구현했다. 구현이 계약과 어긋난 자리는 없었으며, 판단이 필요했던 넷은 `DEV-584`~`DEV-587`로 원장에 있다.
