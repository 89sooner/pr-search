...
- [ ] 검증기·PR CI·병합·main CI: 병합 기록에서 닫는다.
...
- [ ] 검증기·PR CI·병합·main CI: 병합 기록에서 닫는다. 사내 확인 및 기존 미통과 릴리스 게이트를 통과로 바꾸지 않는다.
