...
- 유형: correction(검증 결함 — 시험의 대기 조건). 제품 코드·요구사항·계약·운영 문서는 바꾸지 않는다. 안정 ID 재번호화 0건. 상태: **open** — 브랜치 `fix/flow003-back-hydration`, worktree `/home/roqkf/pr-search-wt/p0-flow003`, 기준 main `3d831a9`.
