...
1. **`srs_final.md` — 변경 없음(v2.7 유지).** 다섯 다 CR-043이 만든 **하위 계약의 결함**이며 승인된 요구 의미는 그대로다. **신규 FR·NFR 없음, 안정 ID 재번호화 0건**
...
7. `40_delivery/pr_search_implementation_traceability.md` — **v3.0.** DEV-286~290 등록, **6.37.1장 신설**(머지 후 리뷰 라운드)
