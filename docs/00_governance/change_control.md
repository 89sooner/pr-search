...
- [x] 문서 검사기 `--strict`: 편집 전(`26e2627`과 같은 문서) 종료 1 · ERROR 4(정의되지 않은 ID `FR-CSS-005`·`D-002`, 자리표시어 13+8) · WARN 2(`risks.md` 경로), 편집 후 같은 6건 — **신규 0건.** strict 전체 통과가 아니다. 원장 6.87장에도 적는다.
