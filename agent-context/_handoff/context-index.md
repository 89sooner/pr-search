...
generated=2026-08-28T01:28:12+00:00
...
- f54408e p=30 src=agent-context/todos.md compact=agent-context/_handoff/compact/f54408e.todos.ctx.md title=다음-작업-미해결-항목-확인할-사항 sig=agent-context/todos.md,7/8,packages/db/migrations/,apps/search-api/src/repositories/overview.ts,apps/search-api/src/repositories/cursor.ts,apps/web/lib/repository-overview.ts,api/repositories,api/v1
...
sha256=b93021fdae6fd49695ce951afcbb8043e2011ac2fbf8ec5211694898c2cff60f
bytes=68416 compact_bytes=68802 lines=1340 priority=45
...
sha256=78e72cbbeae9616b8f26d66df664b760d41ad1758e78fd322fed25c2a19e2d80
bytes=88542 compact_bytes=79318 lines=752 priority=28
...
sha256=e01d004ca4ea49b6974ec34225f8d7458d32735a6e420e80d2ac6d68f207497d
bytes=59066 compact_bytes=58637 lines=689 priority=45
...
sha256=74c0ad8efb6ec0083e83ad48042f01c6ce9473f6e55c701f78d49d1a857a9137
bytes=63019 compact_bytes=44185 lines=947 priority=45
...
sha256=cfc7c18fd08c77e03669322b14007ebb5fe2d95fe3d270479881363de5b93a2d
bytes=49899 compact_bytes=50143 lines=820 priority=25
...
sha256=2a0788b486a8f49e286fe236c6af8b82989cb72032d6e2b3de0d5f76683c9535
bytes=38739 compact_bytes=38940 lines=672 priority=25
...
sha256=7ae2195aec721ebb35b51eb48e48348c6a9fb48d43f6077f9d9ba0217893c083
bytes=55161 compact_bytes=38741 lines=697 priority=30
heads=다음 작업 · 미해결 항목 · 확인할 사항 > A. 지금 당장 — DEV-349 좁은 계약 종결 (WP-036보다 먼저) > WP-034가 깔아 둔 자리 — 다시 만들지 말 것 > B. 그 다음 — WP-036 원본 아카이브 레인 (REL-004 마지막) > 이전 세션 기록 (보존) > WP-033이 깔아 둔 자리 — 다시 만들지 말 것
sig=agent-context/todos.md;7/8;packages/db/migrations/;apps/search-api/src/repositories/overview.ts;apps/search-api/src/repositories/cursor.ts;apps/web/lib/repository-overview.ts;api/repositories;api/v1;api/v1/v1/;8/8;packages/db/src/repositories/saved-search.ts;apps/search-api/src/saved-search/cursor.ts;apps/web/components/SaveSearchDialog.tsx;apps/web/lib/saved-search.ts;api/saved-searches;ingest-gateway/integration/load.test.ts;docs/40_delivery/pr_search_implementation_traceability.md;6/8;5/8;apps/search-api/src/cursor/envelope.ts;apps/search-api/src/search/cursor.ts;sequence/range-cursor.ts;apps/search-api/src/search/facets.ts;packages/es/src/highlight.ts
